...
import { WeekendSettingsModal } from "./components/WeekendSettingsModal";
...
function App() {
  ...
  return <NonWorkingPeriodsProvider periods={data.nonWorkingPeriods} informational={data.workspaceMode === "personal"}><div className={`app-shell mode-${data.workspaceMode}`}>
    ...
    {weekendSettingsOpen && <WeekendSettingsModal periods={data.nonWorkingPeriods} onSave={(periods) => setData((current) => ({ ...current, nonWorkingPeriods: periods }))} onClose={() => setWeekendSettingsOpen(false)} />}
